...
Menampilkan daftar seluruh transaksi yang pernah dicatat.
Fitur:
- Ringkasan Total Income, Expense, dan Balance di bagian atas.
- Tabel riwayat transaksi dengan indikator warna (Hijau/Merah) untuk tipe transaksi.
--}}
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-3 gap-6 mb-6 items-center">
            ...
            <div class="bg-white rounded-2xl p-5 shadow flex flex-col justify-center min-h-[100px]">
                ...
                <p class="text-[20px] font-medium {{ $balanceClass }} truncate">Rp
        ...
        <div class="bg-white shadow rounded-2xl overflow-hidden">
            <table class="w-full">
                ...
                <tbody class="text-sm">
                    {{-- Loop data transaksi ('$transactions') dari Controller --}}
                    @forelse($transactions as $t)
                        <tr class="border-b">
                            ...
                            {{-- Styling Kondisional: Merah jika Expense, Hijau jika Income --}}
