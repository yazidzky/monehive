...
Layout serupa dengan halaman login (Split screen).
--}}
<html lang="en">
...
<body class="font-[Poppins] bg-white">
    ...
    <div class="min-h-screen grid grid-cols-2">
        ...
        <div class="flex flex-col justify-center px-20">
            ...
            {{-- FORM REGISTER (Pendaftaran User) --}}
            <form method="POST" action="{{ route('register') }}" class="space-y-6 w-[420px]">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" autocomplete="email" placeholder="Email address" class="w-full pl-14 pr-5 py-4 rounded-full bg-yellow-200/70
                ...
                <div class="relative">
                    ...
                    <input type="password" name="password" autocomplete="new-password" placeholder="Password" class="w-full pl-14 pr-14 py-4 rounded-full bg-yellow-200/70
                              placeholder-gray-600 focus:outline-none">
