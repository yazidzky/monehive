...
<a href="{{ route('dashboard') }}"
   ...
   {{ request()->routeIs('dashboard')
    ...
    <!-- TRANSACTION -->
    <a href="{{ route('transactions.index') }}" class="flex items-center gap-4 px-5 py-4 rounded-2xl {{ request()->routeIs('transactions.index') ? 'bg-white text-yellow-500' : 'text-white hover:bg-yellow-300' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
             viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- TRANSACTION CREATE -->
    <a href="{{ route('transactions.create') }}" class="flex items-center gap-4 px-5 py-4 rounded-2xl {{ request()->routeIs('transactions.create') ? 'bg-white text-yellow-500' : 'text-white hover:bg-yellow-300' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
             viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
                  d="M12 4v16m8-8H4"/>
    ...
    <!-- WALLETS -->
    <a href="{{ route('wallets.index') }}" class="flex items-center gap-4 px-5 py-4 rounded-2xl {{ request()->routeIs('wallets.index') ? 'bg-white text-yellow-500' : 'text-white hover:bg-yellow-300' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
             viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <!-- BUDGETS -->
    <a href="{{ route('budgets.index') }}" class="flex items-center gap-4 px-5 py-4 rounded-2xl {{ request()->routeIs('budgets.index') ? 'bg-white text-yellow-500' : 'text-white hover:bg-yellow-300' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
             viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round"
